  ...
  return (
    <>
      ...
      >
        ...
        />
        <span className="absolute inset-0 m-auto flex size-12 items-center justify-center-safe rounded-full bg-black/50 text-white transition-colors duration-200 group-hover:bg-black/35">
          <Camera size={24} />
        </span>
      </button>
      {imageToCrop && (
